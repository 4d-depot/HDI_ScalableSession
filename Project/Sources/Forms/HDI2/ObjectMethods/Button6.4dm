...
If (Num:C11(codeWindow)#0)
	CALL FORM:C1391(codeWindow; "fillFunctionCode"; FORM Get current page:C276; "On Startup")
Else 
	...
	$data.content:=_TabLineCode{1}
	$data.htmlTitle:="storage.shtml"
	$data.html:=_TabLineHTML{1}
